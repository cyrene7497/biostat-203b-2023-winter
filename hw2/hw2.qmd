...
system(
  str_c(
    "zcat < ", 
    str_c(mimic_path, "/hosp/labevents_filtered_itemid.csv.gz"), 
    " | head"
    ), 
  intern = TRUE
)
...
```{r}
labevents_tble <- labevents_tble %>% group_by(subject_id,hadm_id,itemid) %>% 
  filter(charttime == min(charttime))
```

4. Summarize the lab measurements by appropriate numerics and graphics. 
```{r}
labevents_tble %>% filter(itemid == 50912) %>% ggplot(aes(valuenum)) + geom_histogram(binwidth = 2) + xlim(0, 50) + ylim(0,10000)
```
```{r}
labevents_tble %>% filter(itemid == 50971) %>% ggplot(aes(valuenum)) + geom_histogram()
```
```{r}
labevents_tble %>% filter(itemid == 50983) %>% ggplot(aes(valuenum)) + geom_histogram()
```
```{r}
labevents_tble %>% filter(itemid == 50902) %>% ggplot(aes(valuenum)) + geom_histogram()
```
```{r}
labevents_tble %>% filter(itemid == 50882) %>% ggplot(aes(valuenum)) + geom_histogram()
```
```{r}
labevents_tble %>% filter(itemid == 51221) %>% ggplot(aes(valuenum)) + geom_histogram()
```
```{r}
labevents_tble %>% filter(itemid == 51301) %>% ggplot(aes(valuenum)) + geom_histogram()
```
```{r}
labevents_tble %>% filter(itemid == 50931) %>% ggplot(aes(valuenum)) + geom_histogram()
```
...
```{r}
chartevents_tble <- chartevents_tble %>% group_by(subject_id,hadm_id,itemid) %>% 
  filter(charttime == min(charttime))
```

3. Summarize these vital measurements by appropriate numerics and graphics. 
```{r}
chartevents_tble %>% filter(itemid == 220045) %>% ggplot(aes(valuenum)) + geom_histogram() + xlim(0,200)
```
```{r}
chartevents_tble %>% filter(itemid == 220181) %>% ggplot(aes(valuenum)) + geom_histogram() + xlim(0,200)
```
```{r}
chartevents_tble %>% filter(itemid == 220179) %>% ggplot(aes(valuenum)) + geom_histogram()+ xlim(0,300)
```
```{r}
chartevents_tble %>% filter(itemid == 223761) %>% ggplot(aes(valuenum)) + geom_histogram(binwidth = 1) + xlim(20,150)
chartevents_tble %>% filter(itemid == 223761) %>% ggplot(aes(x = itemid, y = valuenum)) + geom_boxplot()
```
```{r}
chartevents_tble %>% filter(itemid == 220210) %>% ggplot(aes(valuenum)) + geom_histogram()
```
